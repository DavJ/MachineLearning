...
def _write_report(
    ...
    a("- The expected recall@6 under the null (uniform) is `6/49 ≈ 0.0857` per number")
    a("  drawn, or equivalently `7 * (6/49) / 7 = 6/49 ≈ 0.857` of drawn numbers")
    a("  recovered if 6 are predicted.  A fairer baseline is `6 * 7 / 49 ≈ 0.857`.")
    a("")
